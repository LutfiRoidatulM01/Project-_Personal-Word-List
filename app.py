...
def detail(keyword):
    ...
    if not definitions:
        return render_template('error.html', msg=f'Your word "{keyword}", could not be found')

    if type(definitions[0]) is str:
        return render_template('error.html', msg=f'Could not find "{keyword}", did you mean {", ".join(definitions)}')
